...
#define COCOAPODS_VERSION_MAJOR_VENCore 1
#define COCOAPODS_VERSION_MINOR_VENCore 0
#define COCOAPODS_VERSION_PATCH_VENCore 0

// Venmo-iOS-SDK
#define COCOAPODS_POD_AVAILABLE_Venmo_iOS_SDK
#define COCOAPODS_VERSION_MAJOR_Venmo_iOS_SDK 1
#define COCOAPODS_VERSION_MINOR_Venmo_iOS_SDK 0
#define COCOAPODS_VERSION_PATCH_Venmo_iOS_SDK 2
